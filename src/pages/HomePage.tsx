...
export const HomePage = () => {
    ...
    return (
        <>
            ...
            <main
                id="home"
                className={`pt-16 px-4 md:px-6 lg:px-12 min-h-screen flex flex-col justify-center items-start `}
            >
                <section className="lg:grid lg:grid-cols-2 lg:gap-5">
                    ...
                    >
                        ...
                        <img
                            ...
                            alt=""
                            className="hidden lg:block lg:basis-auto " />
                    </motion.div>
            ...
            <section
                ...
                id="technologies"
                className={`px-4 md:px-6 lg:px-12 bg-base-200 py-10 sm:py-12 md:py-14`}>
                <article className="space-y-4">
